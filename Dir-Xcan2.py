...
parser = argparse.ArgumentParser(
				...
				epilog='I wrote this program to get used to Python with Arguments and Files')
...
print '''
 ...
 Release Date 09/01/2014  - Release Version V.2.0
 By @NoobieDog
'''
...
with open(listing) as f:
	...
	for line in f:													# on each line
		...
		try: 
			url = urllib2.urlopen(target + '/' + str(line)) 		# try each line in file with the given url or ip
			...
			Found += 1
			LinesLeft -= 1
			outputfile.write("<A HREF='" + target + "/" + line + "'>" + target + '/' + line + "<br>\n");	
